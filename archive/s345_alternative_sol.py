...
class ListMath:
    ...
    def __init__(self, init_values: Sequence = []) -> None:
        self.__init_values = [
            val for val in init_values if type(val) == int or type(val) == float
        ]
